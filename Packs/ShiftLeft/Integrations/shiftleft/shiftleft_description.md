...
To use this content pack, you will need to have an enterprise account with ShiftLeft CORE to access the API and get coverage for known open source vulnerabilities. To get your Org ID and Token in ShiftLeft CORE:
- Log in to ShiftLeft.
