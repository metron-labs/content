...
For the integration you need your MetaDefender Sandbox API key.
...
Notice: Submitting indicators using the ***metadefender-sandbox-scan-url*** command of this integration might make the indicator data publicly available.  See the vendor’s documentation for more details.